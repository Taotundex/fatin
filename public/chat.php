            ...
            <div class="col col-lg-1 col-md-11 col-12">
                <div class="sidebar">
                    ...
                    <ul>
                        ...
                        <li><a href="chat.php#last" class="active"><i class="bi bi-chat-left"></i></a></li>
                ...
                <div class="body mb-lg-0 mb-md-0 mb-5">
                  ...
                  <div class="bottombar d-lg-none d-md-none d-block p-3 shadow-sm">
                      <ul class="d-flex justify-content-between align-items-center">
                          ...
                          <li><a href="chat.php#last" class="d-flex flex-column text-center gap-2 active"><i class="bi bi-chat-left"></i>Chat</a></li>
